...
namespace ArcsomAssetManagement.Client.Migrations
{
    ...
    [Migration("20250609133035_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArcsomAssetManagement.Api.Models.Asset", b =>
                {
            ...
            modelBuilder.Entity("ArcsomAssetManagement.Api.Models.Role", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("ArcsomAssetManagement.Api.Models.User", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("ArcsomAssetManagement.Api.Models.Asset", b =>
                {
                    b.HasOne("ArcsomAssetManagement.Api.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<ulong>", b =>
                {
                    b.HasOne("ArcsomAssetManagement.Api.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<ulong>", b =>
                {
                    b.HasOne("ArcsomAssetManagement.Api.Models.User", null)
                        .WithMany()
